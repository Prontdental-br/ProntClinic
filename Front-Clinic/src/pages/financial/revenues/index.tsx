...
interface RevenuesModalProps {
  ...
  planos: Array<{ id: string; desc: string }> // Substitua pelo seu objeto JSON de planos
  tratamentos: Array<{ id: string; desc: string }> // Substitua pelo seu objeto JSON de tratamentos
...
const RevenuesModal: React.FC<RevenuesModalProps> = ({ open, handleClose, handleSave, formData }) => {
 ...
 const validateFields = () => {
  ...
  return (
    ...
    >
      <DialogTitle id='expense-modal-title'>Cadastrar Receita</DialogTitle>
      <DialogContent>
        <DialogContentText sx={{ mb: 5 }} variant='body1' id='expense-modal-description'>
          Preencha os detalhes da Receita.
        </DialogContentText>
        <form>
      ...
      <DialogActions>
        ...
        <Button variant='contained' color='primary' onClick={() => {
          ...
          if (validateFields()) {
            ...
            handleSave({...expenseData, dueDate: dueDateFinal, paymentType: expenseData.isPaid ? paymentMethod : null,  paymentDate:  expenseData?.isPaid && selectedPaymentDate
