    ...
    <>
        ...
        <Box mb={3} display='flex' justifyContent='space-between' alignItems='center'>
          <Box>
            ...
            <Typography variant='body2' color='text.secondary'>
              Gerencie seus modelos de contratos personalizados para agilizar o processo de formalização com seus
              pacientes.
            </Typography>
          </Box>
      ...
      <Dialog open={openNewContract} onClose={handleCloseModal} fullWidth maxWidth='md'>
        <DialogTitle sx={{ display: 'flex', backgroundColor: '#e0e0e0ff', pl: 4, pt: 3, pb: 1, mb: 2 }}>
          {editingContractId ? 'Editar Modelo de Contrato' : 'Novo Modelo de Contrato'}
        </DialogTitle>
        <DialogContent sx={{ pb: 8, px: { xs: 6, sm: 12 }, pt: { xs: 8, sm: 12 }, position: 'relative' }}>
          <DialogContentText mb={2}>
            {editingContractId
              ? 'Edite o modelo de contrato existente.'
              : 'Crie um novo modelo de contrato para ser utilizado com seus pacientes. Você poderá editar o conteúdo posteriormente.'}
          </DialogContentText>
