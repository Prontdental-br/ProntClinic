...
const PricingHeader = (props: Props) => {
  ...
  return (
    <Box sx={{ mb: [10, 17.5], textAlign: 'center' }}>
      <Typography variant='h4'>Preços e Planos</Typography>
      <Box sx={{ mt: 2.5, mb: 10.75 }}>
        <Typography variant='body2'>
          Todos os planos incluem mais de 40 ferramentas e recursos avançados para impulsionar sua clínica.
        </Typography>
        <Typography variant='body2'>Escolha o melhor plano para atender às suas necessidades.</Typography>
      </Box>
      <Box sx={{ display: 'flex', position: 'relative', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {/* {!hidden && (
          ...
          >
            ...
            <CustomChip size='small' skin='light' color='primary' label='Economize até 20%' />
          </Box>
        )} */}
      </Box>
    </Box>
