...
Percebemos que você não conseguiu comparecer à consulta agendada conosco.
Acontece, imprevistos fazem parte! 
Se quiser, podemos remarcar para um novo dia e horário que seja melhor pra você.`)
