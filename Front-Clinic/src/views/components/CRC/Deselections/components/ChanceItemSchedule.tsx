  ...
  return (
    ...
    >
      ...
      <Stack>
        ...
        <span style={{ fontSize: '13px', paddingTop: '.3rem', fontWeight: 500 }}>
          {chance.defaultStatus ? statusMap[chance.defaultStatus] ?? chance.defaultStatus : ''}
        </span>
        <span>{chance.amount?.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</span>
      </Stack>
    </Box>
  )
}
