...
import salesContext from '../birthdayContext'
...
function ModalBody() {
  ...
  const [note, setNote] = useState(context.chanceToEdit?.observationCRC || `Olá, ${context.chanceToEdit?.title}! Como vai?
Hoje é um dia especial, e nós da [Nome da Clínica] queremos te desejar um feliz aniversário! 
Que sua jornada seja sempre cheia de saúde, alegrias e muitos sorrisos.

Conte com a gente para continuar cuidando do seu bem-estar!`)
        ...
        <Stack direction='row' style={{ alignItems: 'center' }}>
          ...
          <Stack>
            ...
            <Typography component='p'>
              Data de nascimento: {format(parseISO(context.chanceToEdit?.date ? context.chanceToEdit?.date : ""), 'dd/MM/yyyy')}
