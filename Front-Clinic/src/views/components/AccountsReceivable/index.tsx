...
export const AccountsReceivable = () => {
  ...
  const fetchData = async () => {
    ...
    const { data } = await api.get('/transactions/receivable')
  ...
  return (
    <>
      <Grid container spacing={2} justifyContent='space-between' alignItems='flex-start' flexWrap='wrap' mt={2}>
        <Grid item xs={12} sm={6} md={2}>
          ...
          >
            ...
            >
              <Box sx={{ width: 10, height: 10, borderRadius: '50%', backgroundColor: '#03cc6b' }} /> Recebidos
            </Typography>
        ...
        <Grid item xs={12} sm={6} md={2}>
          ...
          >
            ...
            >
              <Box sx={{ width: 10, height: 10, borderRadius: '50%', backgroundColor: '#f9a825' }} />A receber
            </Typography>
            <Typography sx={{ fontWeight: 700, fontSize: '1.2rem', mt: 1, color: '#f9a825' }}>
              {Number(
                dataDebits.reduce((acc: number, curr: any) => {
