    ...
    '& .react-datepicker': {
      ...
      '& .react-datepicker__day--today': {
        ...
        '&:not(.react-datepicker__day--selected):not(:empty)': {
          color: '#8B18BB',
          backgroundColor: 'rgba(8, 122, 100, 0.1)',
          '&:hover': {
            backgroundColor: 'rgba(8, 122, 100, 0.2)'
          },
...
const AppReactDatepicker = (props: any) => {
  const { boxProps, ...rest } = props

  return (
    <StyledReactDatePicker {...boxProps}>
      <ReactDatePickerComponent popperPlacement='bottom-start' locale='pt-BR' {...rest} />
