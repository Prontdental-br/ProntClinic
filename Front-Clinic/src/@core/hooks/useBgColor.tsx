...
const UseBgColor = () => {
  ...
  return {
    ...
    orangeLight: {
      ...
      backgroundColor: hexToRGBA(theme.palette.orange.main, 0.12)
    },
    bicLight: {
      color: theme.palette.bic.main,
      backgroundColor: hexToRGBA(theme.palette.bic.main, 0.12)
    },
    purpleLight: {
      color: theme.palette.purple.main,
      backgroundColor: hexToRGBA(theme.palette.purple.main, 0.12)
    }
  }
}
