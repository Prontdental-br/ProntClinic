      ...
      <div className='flex justify-center items-center bs-full bg-backgroundPaper !min-is-full p-6 md:!min-is-[unset] md:p-12 md:is-[480px]'>
        ...
        <div className='flex flex-col gap-5 is-full sm:is-auto md:is-full sm:max-is-[400px] md:max-is-[unset] mbs-11 sm:mbs-14 md:mbs-0'>
          <div>
            ...
            <Typography className='mbs-1'>Por favor, entre na sua conta e conheça nossa tecnologia</Typography>
          </div>
          <form
            noValidate
            autoComplete='off'
          ...
          >
            <TextField autoFocus fullWidth label='Email' value={username} onChange={(e:any) => setUsername(e.target.value)} />
            <TextField
              fullWidth
              label='Senha'
            ...
            <div className='flex justify-center items-center flex-wrap gap-2'>
              ...
              <Typography component={Link} color={'warning'} href='/register'>
                Crie a sua conta
              </Typography>
            </div>
