...
# =============================================================================
# MINIO COM ACESSO EXTERNO
# Verificação do MinIO exposto externamente
# =============================================================================
...
echo -e "${CYAN}"
echo "============================================================================="
echo "  MINIO COM ACESSO EXTERNO CONFIGURADO!"
echo "  MinIO exposto via Ingress com URL externa"
echo "============================================================================="
echo -e "${NC}"
...
response=$(curl -s -I http://minio.prontclinic.com.br 2>/dev/null | head -1 || echo "Erro de conexão")
...
if [[ $response == *"200"* ]] || [[ $response == *"302"* ]]; then
    ...
    echo "Verifique se o DNS está configurado para minio.prontclinic.com.br"
fi
...
echo "• URL: http://minio.prontclinic.com.br"
...
echo "  144.22.240.174 minio.prontclinic.com.br"
echo ""
echo "• Ou configure DNS A record:"
echo "  minio.prontclinic.com.br -> 144.22.240.174"
echo ""
...
echo -e "${GREEN}"
echo "============================================================================="
echo "  MINIO EXPOSTO EXTERNAMENTE!"
echo "============================================================================="
echo -e "${NC}"

echo -e "${GREEN}✅ O que foi configurado:${NC}"
echo "• MinIO exposto via Ingress"
echo "• URL externa: http://minio.prontclinic.com.br"
echo "• Credenciais: admin / 749##b*7T5^I5hTx#63f&"
...
echo "1. Configure DNS: minio.prontclinic.com.br -> 144.22.240.174"
echo "2. Acesse: http://minio.prontclinic.com.br"
echo "3. Login: admin / 749##b*7T5^I5hTx#63f&"
echo "4. Configure buckets e políticas"
echo "5. Use a API para integração"
echo ""

echo -e "${GREEN}🎉 MinIO está pronto com acesso externo!${NC}"
echo "Agora o MinIO pode ser acessado externamente via URL."
