# =============================================================================
# PRONTCLINIC - INFRAESTRUTURA KUBERNETES OCI
# Cluster OKE otimizado para produção na Oracle Cloud Infrastructure
# =============================================================================
...
# Route Table para subnets privadas (worker nodes)
...
# Route Table para subnets públicas (load balancers)
...
resource "oci_core_security_list" "oke_private_sl" {
  ...
  # HTTPS para comunicação com o cluster
  ingress_security_rules {
    protocol  = "6"
    source    = var.vcn_cidr
    stateless = false
  ...
  # ICMP para descoberta de caminho
  ingress_security_rules {
    protocol  = "1"
    source    = var.vcn_cidr
    stateless = false
...
resource "oci_containerengine_node_pool" "oke_node_pool" {
  ...
  # Shape x86_64 para compatibilidade
  ...
  # Imagem Oracle Linux 8 x86_64 específica que funciona
  node_source_details {
    source_type = "IMAGE"
